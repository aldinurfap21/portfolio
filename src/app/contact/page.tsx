      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2 flex flex-col justify-center">
            ...
            >
              <h2
                className={`${inter.variable} font-semibold text-2xl md:text-3xl mb-6 text-purple-600 dark:text-purple-400`}
              >
                Let's Connect
              </h2>
              <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300 mb-6">
                Whether you have a project, a question, or just want to say hi, I'd love to hear
                from you. I'm always open to meaningful conversations, collaborations, or even
                sharing a tech tip or two.
              </p>
              <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                Reach out via any of the platforms below. Let's build, share, and innovate
                together!
              </p>
            </section>
                ...
                {socials.map((social, i) => {
                  ...
                  return (
                    <a
                      ...
                      className="flex flex-col items-center p-4 rounded-xl transition-all duration-300 hover:bg-purple-50 dark:hover:bg-gray-800"
                    >
          ...
          <div className="lg:col-span-1 flex justify-center items-start">
            ...
            >
              <div className="bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-900 dark:to-purple-800 rounded-2xl p-8 text-center shadow-md">
                ...
                <h3
                  className={`${inter.variable} font-semibold text-lg text-gray-800 dark:text-gray-200 mb-2`}
                >
                  Ready to Connect
                </h3>
